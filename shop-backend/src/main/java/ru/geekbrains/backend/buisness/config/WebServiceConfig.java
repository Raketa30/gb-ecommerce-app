package ru.geekbrains.backend.buisness.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    // https://localhost:8080/ws/products.wsdl
    @Bean(name = "products")
    public DefaultWsdl11Definition productsWsdl11Definition(XsdSchema productsSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("ProductsPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://gbshop.ru/soap/ws/products");
        wsdl11Definition.setSchema(productsSchema);
        return wsdl11Definition;
    }

    //    https://localhost:8080/ws/categories.wsdl
    ...
    public DefaultWsdl11Definition categoriesWsdl11Definition(XsdSchema categorySchema) {
        ...
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://gbshop.ru/soap/ws/categories");
